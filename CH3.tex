...
\begin{frame}{First Generation (1940-1956): Vacuum Tubes}
    \begin{columns}
        ...
        \begin{column}{0.3\textwidth}
            ...
            % \includegraphics[width=0.5\textwidth]{images/ch3/vacumtubes.png}
...
\begin{frame}{First Generation (1940-1956): Vacuum Tubes (Cont...)} \includegraphics[width=\textwidth]{images/ch3/vacumtubes.png}
            % \small{\textit{Vacuum tubes - massive heat generators}}
...
\begin{frame}{Second Generation (1956-1963): Transistors}
    \begin{columns}
        ...
        \begin{column}{0.4\textwidth}
            ...
            \includegraphics[width=\textwidth]{images/ch3/transistor.png}
...
% \begin{frame}{Second Generation (1956-1963): Transistors (Cont..)}
%     \begin{columns}
%         \begin{column}{0.6\textwidth}
...
\begin{frame}{Second Generation: Programming Language Revolution (Cont...)}
...
\begin{frame}{Third Generation (1964-1971): Integrated Circuits}
    \begin{columns}
        ...
        \begin{column}{0.4\textwidth}
            ...
            \includegraphics[width=\textwidth]{images/ch3/ic.png}
...
\begin{frame}{Fourth Generation (1971-Present): Microprocessors}
    \begin{columns}
        ...
        \begin{column}{0.5\textwidth}
            ...
            \includegraphics[width=\textwidth]{images/ch3/micro_contr.png}
...
\begin{frame}{Fourth Generation (1971-Present): Microprocessors (cont..)}
...
\begin{frame}{Fifth Generation (Present-Beyond): Artificial Intelligence}
    \begin{columns}
        ...
        \begin{column}{0.4\textwidth}
            ...
            \includegraphics[width=\textwidth]{images/ch3/ai.png}
...
\begin{frame}{Heat Generation and Management (cont..)}
    \textbf{Thermal Evolution Across Generations:}
...
\begin{frame}{Social and Economic Impact (cont...)}
...
%     \begin{columns}
%         \begin{column}{0.5\textwidth}
%             \textbf{Booting Definition:}
%             \\Process of loading the operating system onto RAM
...
%         \begin{column}{0.5\textwidth}
%             \textbf{Warm Booting:}
%             \\Restarting computer without turning off power
            
%             \vspace{0.2cm}
%             \textbf{System Services:}
%             \\Time, date, and internal resource management
%         \end{column}
%     \end{columns}
% \end{frame}
...
%         \end{column}
%         \begin{column}{0.5\textwidth}
%             % Placeholder for programming languages
%             % \includegraphics[width=\textwidth]{programming_languages.png}
%             \small{\textit{Various programming language logos}}
%         \end{column}
%     \end{columns}
...
%     \textbf{Compiler:}
%     \begin{itemize}
%         \item Translates entire high-level program at once
...
%     \textbf{Interpreter:}
%     \begin{itemize}
%         \item Translates and executes programs line by line
...
%             % \includegraphics[width=\textwidth]{word_processing.png}
%             \small{\textit{Modern word processing interface}}
%         \end{column}
%     \end{columns}
...
%         \begin{tikzpicture}[scale=0.8]
%             % Input box
%             \node[draw, fill=lightblue, text width=2cm, text centered] at (0,2) {\textbf{INPUT}\\Data entry and conversion};
            
%             % Processing box
%             \node[draw, fill=evolutiongreen, text=white, text width=2.5cm, text centered] at (4,2) {\textbf{PROCESSING}\\CPU manipulation and control};
            
%             % Storage box
%             \node[draw, fill=hardwarered, text=white, text width=2cm, text centered] at (2,0) {\textbf{STORAGE}\\Memory systems};
            
%             % Output box
%             \node[draw, fill=softwareviolet, text=white, text width=2cm, text centered] at (8,2) {\textbf{OUTPUT}\\Information presentation};
            
%             % Arrows showing data flow
%             \draw[->, thick] (1.2,2) -- (2.8,2);
...
%         \end{column}
%         \begin{column}{0.5\textwidth}
%             % Placeholder for CPU diagram
%             % \includegraphics[width=\textwidth]{cpu_architecture.png}
%             \small{\textit{CPU internal architecture}}
%         \end{column}
%     \end{columns}
...
%     \begin{columns}
%         \begin{column}{0.5\textwidth}
%             \textbf{Hard Copy Output:}
%             \begin{itemize}
%                 \item Can be physically held
%                 \item Paper-based documents
%                 \item Examples: Printed reports, photos
...
%             \begin{itemize}
%                 \item Printers (inkjet, laser)
%                 \item Plotters for graphics
%                 \item 3D printers for physical objects
%             \end{itemize}
%         \end{column}
%         \begin{column}{0.5\textwidth}
%             \textbf{Soft Copy Output:}
%             \begin{itemize}
%                 \item Displayed on monitor/screen
%                 \item Digital format information
%                 \item Can be saved to storage devices
%                 \item Examples: Screen displays, digital files
%             \end{itemize}
...
% \begin{frame}{Microcomputers: Personal Computing}
...
%             \item Examples: Digital wristwatch, desktop PC
...
%             \item Examples: Thermometer, barometer
...
%     \begin{enumerate}
%         \item \textbf{Function Keys (F1-F12)}
%         \begin{itemize}
...
%         \item \textbf{Arrow/Cursor-Movement Keys}
%         \begin{itemize}
...
% \begin{frame}{Looking Forward: Next Steps}
%     \begin{center}
%         \Large{\textbf{From Understanding to Application}}
%     \end{center}
    
%     \vspace{0.5cm}
%     \begin{columns}
%         \begin{column}{0.5\textwidth}
%             \textbf{Future Learning Paths:}
%             \begin{itemize}
%                 \item Programming language implementation
%                 \item Advanced system administration
%                 \item Network and security concepts
%                 \item Software development methodologies
%                 \item Emerging technologies exploration
%             \end{itemize}
%         \end{column}
%         \begin{column}{0.5\textwidth}
%             % Placeholder for future technology
%             % \includegraphics[width=\textwidth]{future_computing.png}
%             \small{\textit{Future computing technologies}}
%         \end{column}
%     \end{columns}
    
%     \vspace{0.5cm}
%     \begin{exampleblock}{Practical Application}
%         Use this foundational knowledge to make informed decisions about technology adoption, computer purchases, and career paths in computing.
%     \end{exampleblock}
    
%     \begin{block}{Continuous Evolution}
%         Computer technology continues to evolve rapidly. The principles learned here provide a solid foundation for understanding future developments.
%     \end{block}
% \end{frame}
...
%     \vspace{0.5cm}
%     \begin{alertblock}{Your Computing Future}
%         Armed with this comprehensive understanding, you're prepared to engage with current and future computing technologies as an informed user, student, and potential professional.
%     \end{alertblock}
