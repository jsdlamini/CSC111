...
a) Express \( D \) as an 8-bit number using 2’s complement representation. \hfill (5 marks)\\
b) Calculate the binary sum of A and B. Provide the result in 8-bit binary. \hfill (5 marks)\\
c) Calculate \( A - B \) using the 2’s complement method. Provide the result in 8-bit binary. \hfill (5 marks)\\
d) Compute \( C + D \) using the 2’s complement method. Provide the result in 8-bit binary. \hfill (5 marks)\\
e) Can the number \( -132_{10} \) be represented in this 8-bit machine? Justify your answer. \hfill (5 marks)\\
